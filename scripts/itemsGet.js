...
async function getAndPush(i) {
  ...
  if (res) {
    ...
    // IF DIFFS
    if (DBData[0].name === WoWHeadData.name && DBData[0].icon === WoWHeadData.icon && DBData[0].class === WoWHeadData.class && DBData[0].subclass === WoWHeadData.subclass && DBData[0].quality.toString() === WoWHeadData.quality) {
